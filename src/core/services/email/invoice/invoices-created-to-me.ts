...
const userTempletePath = resolve(__dirname, '..', 'templete', 'me', 'created-invoice.hbs')
...
export const sendInvoicesToMe = async ({ user, invoice, pricing }: SendInvoiceProps) => {
