...
from src.plots.useCases.doubleBar import doubleBarUseCase

doubleBarRouter = APIRouter(
    prefix='/plots',
    tags=['Plots']
)

@doubleBarRouter.post('/double-bar/{extension}/', response_class=FileResponse)
async def controller(
  ...
  if (is_img_extension(extension)):
    ...
    return await doubleBarUseCase(extension, body)
